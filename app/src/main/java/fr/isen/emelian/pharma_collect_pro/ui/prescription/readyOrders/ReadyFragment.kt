...
class ReadyFragment : Fragment(), View.OnClickListener {
            ...
            object : StringRequest(Method.POST, url, Response.Listener<String> { response ->
                ...
                if (jsonResponse["success"] == true) {
                    ...
                    for (i in 0 until jsonArray.length()) {
                        ...
                        if(item["id_prescription"].toString() != "null" && item["status"].toString() == "ready") {
                    ...
                    listPres.onItemClickListener = AdapterView.OnItemClickListener { _, _, p2, _ ->
                        bundlePrescription(listPrescription[p2], R.id.action_readyFragment_to_readyPresFragment)
                    }
                    ...
                    listOrder.onItemClickListener = AdapterView.OnItemClickListener { _, _, p2, _ ->
                        ...
                        navController.navigate(R.id.action_readyFragment_to_readyOrderFragment, bundle)
                    }
