...
class FinishPrescriptionFragment : Fragment(), View.OnClickListener {
    ...
    private lateinit var prescriptionViewModel: FinishPrescriptionViewModel
    ...
    override fun onCreateView(
        ...
        prescriptionViewModel = ViewModelProvider(this).get(FinishPrescriptionViewModel::class.java)
